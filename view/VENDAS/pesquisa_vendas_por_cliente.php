...
<html lang="en">
    ...
    <body>  
        ...
        <div class="container">          
            <div class="row">
                <h2>Relatórios de vendas por cliente</h2>
                <form method="POST" autocomplete="off" action="relatorios_generico.php" >
                    ...
                    <div class="col-xs-12  col-md-10 col-lg-10  col-sm-12">
                        <div class="input-group">
                            ...
                            <input type="text" required class="form-control" id="cli_nome" name="cli_nome"  placeholder="Pesquise o cliente pelo nome">
                        </div><!-- /input-group -->
                    ...
                    <div class="col-xs-12  col-md-12 col-lg-12  col-sm-12">                        
                            <label class="btn btn-primary active">
                                <input type="checkbox" name="imprime_itens"  checked> Imprimir itens da venda
                            </label>                       
                    </div>
